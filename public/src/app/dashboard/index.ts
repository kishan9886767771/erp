...
export { ManageItemsComponent } from './manage-items/manage-items.component';
export { RentalAgreementsComponent } from './rental-agreements/rental-agreements.component';
...
export { BackupRestoreComponent } from './backup-restore/backup-restore.component';
