...
@Component({
  ...
  templateUrl: './rental-agreements.component.html',
  styleUrls: ['./rental-agreements.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [DatePipe]
})
export class RentalAgreementsComponent implements OnInit {

  // Table 1 - external filters
  displayedColumnsTable1: string[] = ['unit', 'dateOfCreation', 'tenant', 'rate', 'dateOfExpiry', 'dateOfEscalation', 'valid', '_id'];
